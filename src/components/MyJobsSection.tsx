    ...
    <div className="space-y-4">
      ...
      {jobs.length === 0 ? (
        <Card className="p-8 text-center">
          <p className="text-chauffer-gray-500">No jobs claimed yet</p>
        </Card>
      ) : (
        <div className="space-y-4">
          {jobs.map((job) => (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-4 text-sm text-chauffer-gray-500">
                      <div className="flex items-center space-x-1">
                        <Clock size={14} />
                        <span>{new Date(job.time).toLocaleString('en-AU')}</span>
                      </div>
                      <div className="flex items-center space-x-1">
                        <DollarSign size={14} />
                        <span className="font-medium text-chauffer-mint">${job.payout}</span>
                      </div>
                    </div>
                  </div>
                </div>
